 ...
 */
public class ConsultadeFolha extends javax.swing.JFrame {

    ChamaMetodos chamametodos = new ChamaMetodos();
    
    public ConsultadeFolha() {
        initComponents();
    ...
    private void initComponents() {
        ...
        SelecaoSetor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Setor1", "Setor2", "Setor3" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cód. Funcionário", "Nome", "CPF", "Setor", "Mês/Ano"
            }
        ) {
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        JOptionPane.showMessageDialog(null, "Você já está na tela de consultas de folhas de pagamento.");
